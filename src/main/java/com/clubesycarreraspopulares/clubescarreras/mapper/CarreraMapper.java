...
public interface CarreraMapper {
    ...
    // DTO -> Entity
    @Mapping(source = "clubId", target = "club") // se asignará manualmente en el controller
    @Mapping(source = "localizacionId", target = "localizacion") // se asignará manualmente en el controller
